<?php
/*twitter plugin*/
function twitter_get($check,$name,$tbn,$post_type,$tbs,$cookie){	$autoapi=json_decode(file_get_contents('https://twitter.com/i/profiles/show/'.$name.'/timeline/tweets?composed_count=0&include_available_features=0&include_entities=0&include_new_items_bar=true&interval=30000&latent_count=0&min_position='.$check),1);
